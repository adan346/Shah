...
module.exports.handleEvent = async function ({
  ...
  var tl = [
    ...
    "Shah Mera owner ha osy bhi koi bachi yes krwa ywr🙂💔",
  ...
  if (
    ...
    return api.sendMessage(
      "🏔️🏝️Shah Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶",
      threadID
    );
  }

  if (
    event.body.toLowerCase() == "The Shah" ||
